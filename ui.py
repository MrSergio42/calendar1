...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.calendar.setGeometry(QtCore.QRect(0, 0, 381, 251))
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(True)
